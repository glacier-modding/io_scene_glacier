...
class Materials:
    ...
    def get_float_values(self, material_name):
        ...
        for m in self.materials:
            if m == material_name:
                if "Float Value" in self.materials[m]["Material"]["Instance"][0]["Binder"][0]:
                    for prop in self.materials[m]["Material"]["Instance"][0]["Binder"][0]["Float Value"]:
        ...
        for m in self.materials:
            if m == material_name:
                if "Color" in self.materials[m]["Material"]["Instance"][0]["Binder"][0]:
                    return self.materials[m]["Material"]["Instance"][0]["Binder"][0]["Color"]
        return []
